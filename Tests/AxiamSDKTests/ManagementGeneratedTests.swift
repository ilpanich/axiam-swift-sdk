...
final class ManagementGeneratedTests: XCTestCase {
    ...
    static let fixtureAssignRoleToGroupRequest: AssignRoleToGroupRequest = decodeFixture(
        ...
        "{\"group_id\": \"11111111-1111-4111-8111-111111111111\", \"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"]}",
    ...
    static let fixtureAssignRoleToServiceAccountRequest: AssignRoleToServiceAccountRequest = decodeFixture(
        ...
        "{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"service_account_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"]}",
    ...
    static let fixtureAssignRoleToUserRequest: AssignRoleToUserRequest = decodeFixture(
        ...
        "{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"], \"user_id\": \"11111111-1111-4111-8111-111111111111\"}",
    ...
    static let fixtureCreateCertificateRequest: CreateCertificateRequest = decodeFixture(
        ...
        "{\"cert_type\": \"User\", \"issuer_ca_id\": \"11111111-1111-4111-8111-111111111111\", \"key_algorithm\": \"Rsa4096\", \"metadata\": {}, \"subject\": \"example\", \"subject_alt_names\": [{\"dns\": \"example\"}], \"validity_days\": 1}",
    ...
    static let fixtureCreateRegistrationTokenRequest: CreateRegistrationTokenRequest = decodeFixture(
        CreateRegistrationTokenRequest.self,
        "{\"expires_in_hours\": 1, \"name\": \"example\"}",
    ...
    static let fixtureGrantScopeConsent: GrantScopeConsent = decodeFixture(
        GrantScopeConsent.self,
        "{\"client_id\": \"example\", \"scopes\": [\"example\"]}",
        "GrantScopeConsent")
    ...
    static let fixtureSignCertificateCsrRequest: SignCertificateCsrRequest = decodeFixture(
        ...
        "{\"cert_type\": \"User\", \"csr_pem\": \"example\", \"issuer_ca_id\": \"11111111-1111-4111-8111-111111111111\", \"metadata\": {}, \"subject_alt_names\": [{\"dns\": \"example\"}], \"validity_days\": 1}",
    ...
    func testRolesListUsersReachesItsRoute() async throws {
        let (client, transport) = try await ManagementFixture.signedIn(
            [(status: 200, body: "[{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"], \"user\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"email\": \"example\", \"email_verified\": true, \"failed_login_attempts\": 1, \"id\": \"11111111-1111-4111-8111-111111111111\", \"is_locked\": true, \"locked_until\": \"2026-08-26T00:00:00Z\", \"metadata\": {}, \"mfa_enabled\": true, \"status\": \"Active\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"updated_at\": \"2026-08-26T00:00:00Z\", \"username\": \"example\"}}]")])
    ...
    func testOauth2ClientsCreateRegistrationTokenReachesItsRoute() async throws {
        let (client, transport) = try await ManagementFixture.signedIn(
            [(status: 200, body: "{\"initial_access_token\": \"example\", \"token\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}}")])
        _ = try await client.oauth2Clients.createRegistrationToken(body: Self.fixtureCreateRegistrationTokenRequest)

        XCTAssertEqual(transport.count, 1)
        XCTAssertEqual(transport.last?.method, "POST")
        XCTAssertEqual(transport.last?.path, "/api/v1/oauth2-clients/registration-tokens")
    }

    func testOauth2ClientsListRegistrationTokensReachesItsRoute() async throws {
        let (client, transport) = try await ManagementFixture.signedIn(
            [(status: 200, body: "[{\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}]")])
        _ = try await client.oauth2Clients.listRegistrationTokens()
    ...
    func testPrivacyListConsentsReachesItsRoute() async throws {
        let (client, transport) = try await ManagementFixture.signedIn(
            [(status: 200, body: "[{\"accepted_at\": \"2026-08-26T00:00:00Z\", \"consent_type\": \"example\", \"version\": \"example\", \"withdrawable\": true}]")])
        _ = try await client.privacy.listConsents()

        XCTAssertEqual(transport.count, 1)
        XCTAssertEqual(transport.last?.method, "GET")
        XCTAssertEqual(transport.last?.path, "/api/v1/account/consents")
    }

    func testPrivacyGrantScopeConsentReachesItsRoute() async throws {
        let (client, transport) = try await ManagementFixture.signedIn(
            [(status: 204, body: "")])
        _ = try await client.privacy.grantScopeConsent(body: Self.fixtureGrantScopeConsent)

        XCTAssertEqual(transport.count, 1)
        XCTAssertEqual(transport.last?.method, "POST")
        XCTAssertEqual(transport.last?.path, "/api/v1/account/consents/oidc-scopes")
    }

    func testPrivacyWithdrawScopeConsentReachesItsRoute() async throws {
        let (client, transport) = try await ManagementFixture.signedIn(
            [(status: 204, body: "")])
        _ = try await client.privacy.withdrawScopeConsent(clientID: "11111111-1111-4111-8111-111111111111")

        XCTAssertEqual(transport.count, 1)
        XCTAssertEqual(transport.last?.method, "DELETE")
        XCTAssertEqual(transport.last?.path, "/api/v1/account/consents/oidc-scopes/11111111-1111-4111-8111-111111111111")
    }
    ...
    func testAssignRoleToGroupRequestRoundTripsWithoutLosingAField() throws {
        let json = "{\"group_id\": \"11111111-1111-4111-8111-111111111111\", \"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"]}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testAssignRoleToServiceAccountRequestRoundTripsWithoutLosingAField() throws {
        let json = "{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"service_account_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"]}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testAssignRoleToUserRequestRoundTripsWithoutLosingAField() throws {
        let json = "{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"], \"user_id\": \"11111111-1111-4111-8111-111111111111\"}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testCertificatePolicyRoundTripsWithoutLosingAField() throws {
        let json = "{\"default_cert_validity_days\": 1, \"max_cert_validity_days\": 1, \"server_cert_allowed_names\": [\"example\"]}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testCimdPolicyRoundTripsWithoutLosingAField() throws {
        let json = "{\"allow_http\": true, \"confidential_only\": true, \"enabled\": true, \"max_cache_secs\": 1, \"max_metadata_bytes\": 1, \"min_cache_secs\": 1, \"restrict_same_domain\": true, \"trusted_client_id_domains\": [\"example\"], \"trusted_redirect_domains\": [\"example\"]}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])

        let value = try JSONDecoder().decode(CimdPolicy.self, from: Data(json.utf8))
        let encoded = try JSONEncoder().encode(value)
        let again = try XCTUnwrap(
            JSONSerialization.jsonObject(with: encoded) as? [String: Any])
        ...
        // And encoding is a fixed point — a second pass changes nothing.
        let twice = try JSONEncoder().encode(
            try JSONDecoder().decode(CimdPolicy.self, from: encoded))
        let third = try XCTUnwrap(
            JSONSerialization.jsonObject(with: twice) as? [String: Any])
        XCTAssertEqual(
            NSDictionary(dictionary: third), NSDictionary(dictionary: again))
    ...
    func testConsentViewRoundTripsWithoutLosingAField() throws {
        let json = "{\"accepted_at\": \"2026-08-26T00:00:00Z\", \"consent_type\": \"example\", \"version\": \"example\", \"withdrawable\": true}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])

        let value = try JSONDecoder().decode(ConsentView.self, from: Data(json.utf8))
        let encoded = try JSONEncoder().encode(value)
        let again = try XCTUnwrap(
            JSONSerialization.jsonObject(with: encoded) as? [String: Any])
        ...
        // And encoding is a fixed point — a second pass changes nothing.
        let twice = try JSONEncoder().encode(
            try JSONDecoder().decode(ConsentView.self, from: encoded))
        let third = try XCTUnwrap(
            JSONSerialization.jsonObject(with: twice) as? [String: Any])
        XCTAssertEqual(
            NSDictionary(dictionary: third), NSDictionary(dictionary: again))
    ...
    func testCreateCertificateRequestRoundTripsWithoutLosingAField() throws {
        let json = "{\"cert_type\": \"User\", \"issuer_ca_id\": \"11111111-1111-4111-8111-111111111111\", \"key_algorithm\": \"Rsa4096\", \"metadata\": {}, \"subject\": \"example\", \"subject_alt_names\": [{\"dns\": \"example\"}], \"validity_days\": 1}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testCreateRegistrationTokenRequestRoundTripsWithoutLosingAField() throws {
        let json = "{\"expires_in_hours\": 1, \"name\": \"example\"}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])

        let value = try JSONDecoder().decode(CreateRegistrationTokenRequest.self, from: Data(json.utf8))
        let encoded = try JSONEncoder().encode(value)
        let again = try XCTUnwrap(
            JSONSerialization.jsonObject(with: encoded) as? [String: Any])
        ...
        // And encoding is a fixed point — a second pass changes nothing.
        let twice = try JSONEncoder().encode(
            try JSONDecoder().decode(CreateRegistrationTokenRequest.self, from: encoded))
        let third = try XCTUnwrap(
            JSONSerialization.jsonObject(with: twice) as? [String: Any])
        XCTAssertEqual(
            NSDictionary(dictionary: third), NSDictionary(dictionary: again))
    ...
    func testCreateRegistrationTokenResponseRoundTripsWithoutLosingAField() throws {
        let json = "{\"initial_access_token\": \"example\", \"token\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])

        let value = try JSONDecoder().decode(CreateRegistrationTokenResponse.self, from: Data(json.utf8))
        let encoded = try JSONEncoder().encode(value)
        let again = try XCTUnwrap(
            JSONSerialization.jsonObject(with: encoded) as? [String: Any])
        ...
        // And encoding is a fixed point — a second pass changes nothing.
        let twice = try JSONEncoder().encode(
            try JSONDecoder().decode(CreateRegistrationTokenResponse.self, from: encoded))
        let third = try XCTUnwrap(
            JSONSerialization.jsonObject(with: twice) as? [String: Any])
        XCTAssertEqual(
            NSDictionary(dictionary: third), NSDictionary(dictionary: again))
    ...
    func testGrantScopeConsentRoundTripsWithoutLosingAField() throws {
        let json = "{\"client_id\": \"example\", \"scopes\": [\"example\"]}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])

        let value = try JSONDecoder().decode(GrantScopeConsent.self, from: Data(json.utf8))
        let encoded = try JSONEncoder().encode(value)
        let again = try XCTUnwrap(
            JSONSerialization.jsonObject(with: encoded) as? [String: Any])
        ...
        // And encoding is a fixed point — a second pass changes nothing.
        let twice = try JSONEncoder().encode(
            try JSONDecoder().decode(GrantScopeConsent.self, from: encoded))
        let third = try XCTUnwrap(
            JSONSerialization.jsonObject(with: twice) as? [String: Any])
        XCTAssertEqual(
            NSDictionary(dictionary: third), NSDictionary(dictionary: again))
    ...
    func testOidcPolicyRoundTripsWithoutLosingAField() throws {
        ...
        let value = try JSONDecoder().decode(OidcPolicy.self, from: Data(json.utf8))
        let encoded = try JSONEncoder().encode(value)
        let again = try XCTUnwrap(
            JSONSerialization.jsonObject(with: encoded) as? [String: Any])
        ...
        // And encoding is a fixed point — a second pass changes nothing.
        let twice = try JSONEncoder().encode(
            try JSONDecoder().decode(OidcPolicy.self, from: encoded))
        let third = try XCTUnwrap(
            JSONSerialization.jsonObject(with: twice) as? [String: Any])
        XCTAssertEqual(
            NSDictionary(dictionary: third), NSDictionary(dictionary: again))
    ...
    func testRegistrationTokenResponseRoundTripsWithoutLosingAField() throws {
        let json = "{\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])

        let value = try JSONDecoder().decode(RegistrationTokenResponse.self, from: Data(json.utf8))
        let encoded = try JSONEncoder().encode(value)
        let again = try XCTUnwrap(
            JSONSerialization.jsonObject(with: encoded) as? [String: Any])
        ...
        // And encoding is a fixed point — a second pass changes nothing.
        let twice = try JSONEncoder().encode(
            try JSONDecoder().decode(RegistrationTokenResponse.self, from: encoded))
        let third = try XCTUnwrap(
            JSONSerialization.jsonObject(with: twice) as? [String: Any])
        XCTAssertEqual(
            NSDictionary(dictionary: third), NSDictionary(dictionary: again))
    ...
    func testRoleAssignmentRoundTripsWithoutLosingAField() throws {
        let json = "{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"role\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"description\": \"example\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"is_global\": true, \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"updated_at\": \"2026-08-26T00:00:00Z\"}, \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"]}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testRoleServiceAccountAssignmentRoundTripsWithoutLosingAField() throws {
        let json = "{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"service_account\": {\"client_id\": \"example\", \"created_at\": \"2026-08-26T00:00:00Z\", \"description\": \"example\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"status\": \"Active\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"updated_at\": \"2026-08-26T00:00:00Z\"}, \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"]}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testRoleUserAssignmentRoundTripsWithoutLosingAField() throws {
        let json = "{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"], \"user\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"email\": \"example\", \"email_verified\": true, \"failed_login_attempts\": 1, \"id\": \"11111111-1111-4111-8111-111111111111\", \"is_locked\": true, \"locked_until\": \"2026-08-26T00:00:00Z\", \"metadata\": {}, \"mfa_enabled\": true, \"status\": \"Active\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"updated_at\": \"2026-08-26T00:00:00Z\", \"username\": \"example\"}}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testSignCertificateCsrRequestRoundTripsWithoutLosingAField() throws {
        let json = "{\"cert_type\": \"User\", \"csr_pem\": \"example\", \"issuer_ca_id\": \"11111111-1111-4111-8111-111111111111\", \"metadata\": {}, \"subject_alt_names\": [{\"dns\": \"example\"}], \"validity_days\": 1}"
        let wire = try XCTUnwrap(
            JSONSerialization.jsonObject(with: Data(json.utf8)) as? [String: Any])
    ...
    func testCimdPolicyMemberwiseInitializerAssignsEveryProperty() throws {
        let json = "{\"allow_http\": true, \"confidential_only\": true, \"enabled\": true, \"max_cache_secs\": 1, \"max_metadata_bytes\": 1, \"min_cache_secs\": 1, \"restrict_same_domain\": true, \"trusted_client_id_domains\": [\"example\"], \"trusted_redirect_domains\": [\"example\"]}"
        let decoded = try JSONDecoder().decode(CimdPolicy.self, from: Data(json.utf8))

        // Every property handed straight back through the memberwise initializer. Two
        // same-typed properties assigned to each other's stored property is a defect a
        // decode-only test cannot see -- the JSON round trip above would pass, because it never
        // constructs one by hand.
        let rebuilt = CimdPolicy(
            allowHttp: decoded.allowHttp,
            confidentialOnly: decoded.confidentialOnly,
            enabled: decoded.enabled,
            maxCacheSecs: decoded.maxCacheSecs,
            maxMetadataBytes: decoded.maxMetadataBytes,
            minCacheSecs: decoded.minCacheSecs,
            restrictSameDomain: decoded.restrictSameDomain,
            trustedClientIDDomains: decoded.trustedClientIDDomains,
            trustedRedirectDomains: decoded.trustedRedirectDomains)
    ...
    func testConsentViewMemberwiseInitializerAssignsEveryProperty() throws {
        let json = "{\"accepted_at\": \"2026-08-26T00:00:00Z\", \"consent_type\": \"example\", \"version\": \"example\", \"withdrawable\": true}"
        let decoded = try JSONDecoder().decode(ConsentView.self, from: Data(json.utf8))

        // Every property handed straight back through the memberwise initializer. Two
        // same-typed properties assigned to each other's stored property is a defect a
        // decode-only test cannot see -- the JSON round trip above would pass, because it never
        // constructs one by hand.
        let rebuilt = ConsentView(
            acceptedAt: decoded.acceptedAt,
            consentType: decoded.consentType,
            version: decoded.version,
            withdrawable: decoded.withdrawable)
    ...
    func testCreateCertificateRequestMemberwiseInitializerAssignsEveryProperty() throws {
        ...
        let rebuilt = CreateCertificateRequest(
            ...
            metadata: decoded.metadata,
            subject: decoded.subject,
            subjectAltNames: decoded.subjectAltNames,
            validityDays: decoded.validityDays)
    ...
    func testCreateRegistrationTokenRequestMemberwiseInitializerAssignsEveryProperty() throws {
        let json = "{\"expires_in_hours\": 1, \"name\": \"example\"}"
        let decoded = try JSONDecoder().decode(CreateRegistrationTokenRequest.self, from: Data(json.utf8))

        // Every property handed straight back through the memberwise initializer. Two
        // same-typed properties assigned to each other's stored property is a defect a
        // decode-only test cannot see -- the JSON round trip above would pass, because it never
        // constructs one by hand.
        let rebuilt = CreateRegistrationTokenRequest(
            expiresInHours: decoded.expiresInHours,
            name: decoded.name)
    ...
    func testCreateRegistrationTokenResponseMemberwiseInitializerAssignsEveryProperty() throws {
        let json = "{\"initial_access_token\": \"example\", \"token\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}}"
        let decoded = try JSONDecoder().decode(CreateRegistrationTokenResponse.self, from: Data(json.utf8))

        // Every property handed straight back through the memberwise initializer. Two
        // same-typed properties assigned to each other's stored property is a defect a
        // decode-only test cannot see -- the JSON round trip above would pass, because it never
        // constructs one by hand.
        let rebuilt = CreateRegistrationTokenResponse(
            initialAccessToken: decoded.initialAccessToken,
            token: decoded.token)
    ...
    func testGrantScopeConsentMemberwiseInitializerAssignsEveryProperty() throws {
        let json = "{\"client_id\": \"example\", \"scopes\": [\"example\"]}"
        let decoded = try JSONDecoder().decode(GrantScopeConsent.self, from: Data(json.utf8))

        // Every property handed straight back through the memberwise initializer. Two
        // same-typed properties assigned to each other's stored property is a defect a
        // decode-only test cannot see -- the JSON round trip above would pass, because it never
        // constructs one by hand.
        let rebuilt = GrantScopeConsent(
            clientID: decoded.clientID,
            scopes: decoded.scopes)
    ...
    func testOAuth2ClientResponseMemberwiseInitializerAssignsEveryProperty() throws {
        ...
        let rebuilt = OAuth2ClientResponse(
            ...
            jwks: decoded.jwks,
            jwksURI: decoded.jwksURI,
            lastAuthorizedAt: decoded.lastAuthorizedAt,
            managedBy: decoded.managedBy,
            name: decoded.name,
            profile: decoded.profile,
            redirectUris: decoded.redirectUris,
            requirePar: decoded.requirePar,
    ...
    func testOidcPolicyMemberwiseInitializerAssignsEveryProperty() throws {
        ...
        // decode-only test cannot see -- the JSON round trip above would pass, because it never
        // constructs one by hand.
        let rebuilt = OidcPolicy(
            cimd: decoded.cimd,
            dcrAllowedRedirectHosts: decoded.dcrAllowedRedirectHosts,
            dcrAllowedScopes: decoded.dcrAllowedScopes,
            dcrMaxClients: decoded.dcrMaxClients,
            dcrUnusedClientTTLDays: decoded.dcrUnusedClientTTLDays,
    ...
    func testRegistrationTokenResponseMemberwiseInitializerAssignsEveryProperty() throws {
        let json = "{\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}"
        let decoded = try JSONDecoder().decode(RegistrationTokenResponse.self, from: Data(json.utf8))

        // Every property handed straight back through the memberwise initializer. Two
        // same-typed properties assigned to each other's stored property is a defect a
        // decode-only test cannot see -- the JSON round trip above would pass, because it never
        // constructs one by hand.
        let rebuilt = RegistrationTokenResponse(
            createdAt: decoded.createdAt,
            createdBy: decoded.createdBy,
            expiresAt: decoded.expiresAt,
            id: decoded.id,
            name: decoded.name,
            tenantID: decoded.tenantID,
            usedAt: decoded.usedAt,
            usedByClientID: decoded.usedByClientID)
    ...
    func testAuthnRequestParamsModeMapsEveryValueBothWays() throws {
        XCTAssertEqual(AuthnRequestParamsMode.allCases.count, 3)
        XCTAssertEqual(AuthnRequestParamsMode.ignore.rawValue, "ignore")
        XCTAssertEqual(AuthnRequestParamsMode(rawValue: "ignore"), AuthnRequestParamsMode.ignore)
        XCTAssertEqual(AuthnRequestParamsMode.honour.rawValue, "honour")
        XCTAssertEqual(AuthnRequestParamsMode(rawValue: "honour"), AuthnRequestParamsMode.honour)

        // The raw-value initializer stays STRICT: an unrecognised value is nil, never whichever
        // case happens to be first. Code that parses a raw string keeps its check.
        XCTAssertNil(AuthnRequestParamsMode(rawValue: "__not_a_authn_request_params_mode__"))
        ...
        // known ones.
        let stranger = try JSONDecoder().decode(
            [AuthnRequestParamsMode].self,
            from: Data("[\"__not_a_authn_request_params_mode__\"]".utf8))
        XCTAssertEqual(stranger, [AuthnRequestParamsMode.unknown])
    ...
    func testCertificateTypeMapsEveryValueBothWays() throws {
        XCTAssertEqual(CertificateType.allCases.count, 5)
        ...
        XCTAssertEqual(CertificateType.server.rawValue, "Server")
        XCTAssertEqual(CertificateType(rawValue: "Server"), CertificateType.server)
    ...
    func testClientAuthMethodMapsEveryValueBothWays() throws {
        ...
        XCTAssertEqual(ClientAuthMethod.clientSecretBasic.rawValue, "client_secret_basic")
        XCTAssertEqual(ClientAuthMethod(rawValue: "client_secret_basic"), ClientAuthMethod.clientSecretBasic)
        ...
        XCTAssertEqual(ClientAuthMethod.none.rawValue, "none")
        XCTAssertEqual(ClientAuthMethod(rawValue: "none"), ClientAuthMethod.none)
        ...
        XCTAssertNotEqual(ClientAuthMethod.unknown, ClientAuthMethod.clientSecretBasic)
    ...
    func testManagedByMapsEveryValueBothWays() throws {
        XCTAssertEqual(ManagedBy.allCases.count, 4)
        XCTAssertEqual(ManagedBy.admin.rawValue, "admin")
        XCTAssertEqual(ManagedBy(rawValue: "admin"), ManagedBy.admin)
        XCTAssertEqual(ManagedBy.dcr.rawValue, "dcr")
        XCTAssertEqual(ManagedBy(rawValue: "dcr"), ManagedBy.dcr)
        XCTAssertEqual(ManagedBy.cimd.rawValue, "cimd")
        XCTAssertEqual(ManagedBy(rawValue: "cimd"), ManagedBy.cimd)

        // The raw-value initializer stays STRICT: an unrecognised value is nil, never whichever
        // case happens to be first. Code that parses a raw string keeps its check.
        XCTAssertNil(ManagedBy(rawValue: "__not_a_managed_by__"))
        ...
        let stranger = try JSONDecoder().decode(
            [ManagedBy].self,
            from: Data("[\"__not_a_managed_by__\"]".utf8))
        XCTAssertEqual(stranger, [ManagedBy.unknown])
        XCTAssertNotEqual(ManagedBy.unknown, ManagedBy.admin)
